...
public readonly struct Metadata
{
    ...
    public float Hash
      => _hash;
        ...
        public Metadata(Transform camera, in Matrix4x4 projection, Vector2 range, Transform experienceOrigin, long? timestamp)
       
    {
        ...
        _arz = ar.z * arsign;
            ...
            _t1 = (float)(timestamp & 0xffffffff);
            _t2 = (float)(timestamp >> 32);
